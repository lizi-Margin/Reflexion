...
from corleone.training.trainer import EnhancedSelfPlayTrainer, TrainingConfig, AgentConfig
...
def load_preset_config(preset_name: str) -> TrainingConfig:
    ...
    configs_path = os.path.join(project_root, "configs", "training_configs.json")
  ...
  %(prog)s --list-presets                     # Show available presets
    ...
    try:
        ...
        final_report = trainer.run_training_session(
            ...
            games_per_batch=config.games_per_session
        )
